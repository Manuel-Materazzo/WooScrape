...
require_once plugin_dir_path( __DIR__ ) . 'vendor/simple_html_dom.php';
require_once plugin_dir_path( __DIR__ ) . 'services/class-woo-scrape-fishdeal-crawler-service.php';
